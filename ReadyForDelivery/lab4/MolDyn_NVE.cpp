...
void Averages(int iblk) {
	...
	WriteEtot.open(phase[index_ph] + "_Ar_etot.out",ios::app);
        WriteEpot.open(phase[index_ph] + "_Ar_epot.out",ios::app);
        WriteEkin.open(phase[index_ph] + "_Ar_ekin.out",ios::app);
        WriteTemp.open(phase[index_ph] + "_Ar_temp.out",ios::app);
